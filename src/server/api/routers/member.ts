...
export const memberRouter = createTRPCRouter({
  ...
  takeover: permissionProtectedProcedure(["update:member"])
    .input(
      z.object({
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      // Check if new user already has a membership
      ...
      return ctx.db.$transaction(async (tx) => {
        ...
        // Log the takeover action (you can create a separate log table if needed)
        // For now, we'll add a comment or note in the system
