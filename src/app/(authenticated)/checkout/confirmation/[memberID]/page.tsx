...
{ enabled: false },
  ...
  const checkPaymentStatus = async () => {
    ...
    try {
      ...
      if (result.data) {
        ...
        console.log(
          `Mapped status to: ${status}, current payment status: ${payment?.status}`,
        );
  ...
  if (isLoadingSubscription) {
    return (
      <div className="container mx-auto flex min-h-[50vh] items-center justify-center p-5">
    ...
    return (
      <div className="container mx-auto p-5">
        <Alert variant="destructive" className="mb-6">
          ...
          <AlertDescription>
            We couldn't find the subscription information. Please contact
            support.
          </AlertDescription>
        </Alert>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div>
                    {subscription?.package?.type === "GYM_MEMBERSHIP"
                      ? "Gym Membership"
                      : "Personal Training"}
                  </div>
              ...
              {payment?.status === "PENDING" && (
                <Alert className="border-yellow-200 bg-yellow-50">
                  ...
                  <AlertDescription className="text-yellow-700">
                    Your subscription will be activated as soon as we receive
                    confirmation of your payment. This page will update
              ...
              {payment?.status === "FAILED" && (
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    We couldn't process your payment. You can try again or
              ...
              {payment?.status === "SUCCESS" && (
                <Alert className="border-green-200 bg-green-50">
                  ...
                  <AlertDescription className="text-green-700">
                    Your subscription is now active. You can now enjoy all the
        ...
        <div>
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <h3 className="mb-2 font-medium">Try Another Payment Method</h3>
                <p className="text-sm text-muted-foreground">
                  If you're experiencing issues with your current payment
                  method, you can try a different one.
                </p>
              </div>
            </CardContent>
            <CardFooter>
