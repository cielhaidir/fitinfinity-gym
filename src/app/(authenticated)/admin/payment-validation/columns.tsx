...
import { type PaymentValidationItem } from "./page"; // Import the type from page.tsx
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem
              onClick={() => onViewProof(validation.filePath!)}
              disabled={!validation.filePath}
            >
