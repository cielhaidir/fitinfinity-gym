...
import { columns } from "@/app/(authenticated)/management/member/components/columns"
...
async function getTasks() {
  const data = await fs.readFile(
    path.join(process.cwd(), "src/app/(authenticated)/management/member/data/tasks.json")
  )
