...
export default function TransactionPage() {
    ...
    const { data: transactions = { items: [], total: 0, page: 1, limit: 10 }, isLoading } = api.transaction.list.useQuery({
        page,
        limit,
        search,
        searchColumn,
    ...
    const handleDeleteTransaction = async (transaction: Transaction) => {
        ...
        try {
            const promise = deleteTransactionMutation.mutateAsync({ id: transaction.id });
            ...
            >
                <div className="h-full flex-1 flex-col space-y-8 p-8 md:flex">
                    ...
                    <DataTable
                        ...
                        searchColumns={[
                            { id: "transaction_number", placeholder: "Search by transaction number..." },
