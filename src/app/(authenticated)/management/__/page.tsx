...
export default function SubscriptionPage() {
  ...
  // Function to navigate to payment confirmation page for online payments
  const goToPaymentStatus = (memberId: string, orderReference: string) => {
    if (memberId) {
      router.push(
  ...
  const columns = createColumns({
    ...
    onEdit: handleEdit,
    onCheckPayment: goToPaymentStatus,
  });
          ...
          <div className="py-4">
            ...
            <div className="max-h-[400px] overflow-y-auto">
              {members.items.map((member) => (
                <div
                  key={member.id}
                  className="flex cursor-pointer items-center justify-between rounded-lg p-4 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-50"
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              subscription and all associated payment records.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
