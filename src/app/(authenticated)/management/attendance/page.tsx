...
export default function AttendanceManagementPage() {
  ...
  const [searchType, setSearchType] = useState<"employee" | "device" | "fingerprint">("employee");
  const [attendanceType, setAttendanceType] = useState<"all" | "checkin" | "checkout">("all");
  const limit = 20;
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            View and manage all fingerprint attendance records
          </p>
        </div>
        <Button
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={searchType} onValueChange={(value: "employee" | "device" | "fingerprint") => setSearchType(value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              <Select value={attendanceType} onValueChange={(value: "all" | "checkin" | "checkout") => setAttendanceType(value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
