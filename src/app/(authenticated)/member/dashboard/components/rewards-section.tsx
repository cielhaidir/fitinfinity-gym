...
export function RewardsSection() {
    ...
    const handleRedeem = (reward: { id: string; name: string; price: number }) => {
        if (!session?.user?.id) {
            ...
            <Dialog open={isConfirmModalOpen} onOpenChange={setIsConfirmModalOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Are you sure you want to redeem {selectedReward?.name} for {selectedReward?.price} points?
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
            ...
            <Dialog open={isSuccessModalOpen} onOpenChange={setIsSuccessModalOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Please screenshot this page and show it to the cashier to claim your reward.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="mt-4 space-y-4 rounded-lg border p-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">{selectedReward?.price} points</p>
                        </div>
                    </div>
                    <DialogFooter>
