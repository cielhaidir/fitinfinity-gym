  ...
  if (isLoading) {
    return (
      <div className="container mx-auto px-4 py-8">
        <h1 className="mb-8 text-2xl font-bold">Personal Trainers</h1>
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {trainers?.map((trainer) => (
          <div
            key={trainer.id}
            className="group relative overflow-hidden rounded-lg shadow-lg transition-all duration-500 hover:shadow-2xl hover:shadow-[#BFFF00]/20"
          >
            ...
            <div className="absolute bottom-0 w-full transform p-4 transition-all duration-500 group-hover:translate-y-[-8px]">
              <h3 className="mb-2 text-xl font-bold text-white transition-all duration-500 group-hover:text-[#BFFF00]">
                {trainer.user.name}
              </h3>
              <p className="mb-3 text-sm italic text-gray-200 transition-all duration-500 group-hover:text-white">
