        ...
        >
          {renderItems.map((value) => {
            ...
            const el = (
              ...
              >
                <span>{child}</span>
                <X className="ml-1 size-3 text-neutral-500 group-hover/multi-select-badge:text-foreground dark:text-neutral-400" />
              </Badge>
            );
          ...
          {renderRemain ? (
            <span className="py-.5 text-xs leading-4 text-neutral-500 dark:text-neutral-400">
              +{renderRemain}
            </span>
          ) : null}
        </div>
